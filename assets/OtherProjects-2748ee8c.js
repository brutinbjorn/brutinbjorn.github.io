import{P as e,a as s}from"./ProjectData-3118035b.js";import{f as i,_ as o,r as n,c,d as l,a as t,o as h}from"./index-c3683aeb.js";const d=[new e("project-6","MiniArcade C++","img/projects/Cursed_Arcade.jpeg",`
    <div class="paragraph">
    ...
    <div class="paragraph">
            ...
            `,"#1ca1e2"),new e("project-8","Zombie survival AI C++","img/projects/project-8-icon.png",`
            <div class="paragraph">
     ...
     <div class="paragraph">
        ...
        <li>And then some</li>
            ...
            </div>`)],p=i({name:"OtherProjects",components:{ProjectsList:s},data:function(){return{projects:d}}}),g=t("h1",null,"Other stuff",-1),m=t("div",{style:{"margin-bottom":"30px"}}," And here are some other stuff I've made or heavily contributed to, which are totally different than the stuff from earlier. ",-1);function u(a,f,b,v,j,k){const r=n("ProjectsList");return h(),c("div",null,[g,m,l(r,{projects:a.projects},null,8,["projects"])])}const A=o(p,[["render",u]]);export{A as default};
