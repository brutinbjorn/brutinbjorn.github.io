import{P as e,a as s}from"./ProjectData-c4f7d3ab.js";import{f as o,_ as n,r as i,c,d as l,a,b as d,o as p}from"./index-bfc605c1.js";const h=[new e("project-1","Replaceable","img/projects/Replaceable_Icon.jpg",`
    <div class="paragraph">
    ...
    `,"#0033cc",!0),new e("project-2","Slumberland","img/projects/SlumberLand_Icon.png",`
    <div class="paragraph">
        <strong>Slumberland</strong> Was made in my 3rd year of DAE, where i worked in a Team off 7. </br>
        Me and a fellow programmer, 3 Artist, 2 Independant Game Producers, and a animator. </br>
        Made for MyMachine, a global orginization that helps children in there education. </br>
    ...
    <div class="paragraph center">
        <iframe class="youtube" src="https://www.youtube.com/embed/l3_uSAb8DKI" frameborder="0" allowfullscreen></iframe>
    </div>
    ...
    `,"#5a78af"),new e("project-3","Dont let them eat cake.","img/projects/DontLetThemEatCake_Icon.png",`
    <div class="paragraph">
        <strong>Dont let them eat cake.</strong>Was made during the 2022 DAE Game in witch Me, and 4 other students game together to create a game in 1 week. </br>
        Me as the programmer, 1 student from Independant game production and 3 Artist. </br>
    ...
    `,"#00ff99"),new e("project-4","Underfed","img/projects/Underfed_Icon.png",`
    <div class="paragraph">
    ...
    `,"#e80fb7")],m=o({name:"GameProjects",components:{ProjectsList:s},data:function(){return{projects:h}}}),g=a("h1",null,"Games I worked on.",-1),f=a("div",{style:{"margin-bottom":"30px"}}," The following are some Games I've made or heavily contributed to. ",-1),b=a("div",{style:{"margin-top":"20px"}},[d(" There is more to see on "),a("a",{target:"_blank",href:"https://someexternalwebsite.com"},"some external website")],-1);function u(t,v,w,y,_,j){const r=i("ProjectsList");return p(),c("div",null,[g,f,l(r,{projects:t.projects},null,8,["projects"]),b])}const I=n(m,[["render",u]]);export{I as default};
